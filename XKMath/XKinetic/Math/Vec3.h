...
XK_INLINE XKMATH_API XkBool8 xkVec3Compare(const XkVec3 a, const XkVec3 b) {
#if defined(__XKMATH_AVX__) || defined(__XKMATH_AVX2__)
	/// TODO: Implementation.
#else
...
XK_INLINE XKMATH_API XkBool8 xkDVec3Compare(const XkDVec3 a, const XkDVec3 b) {
#if defined(__XKMATH_AVX__) || defined(__XKMATH_AVX2__)
	/// TODO: Implementation.
#else
...
XK_INLINE XKMATH_API XkFloat32 xkVec3Length(const XkVec3 a) {
	return xkFSqrt(a.x * a.x + a.y * a.y + a.z * a.z);
}

XK_INLINE XKMATH_API XkFloat64 xkDVec3Length(const XkDVec3 a) {
	return xkDSqrt(a.x * a.x + a.y * a.y + a.z * a.z);
}
