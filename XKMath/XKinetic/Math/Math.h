...
XKMATH_API XkFloat32 xkFCosA(const XkFloat32);
XKMATH_API XkFloat64 xkDCosA(const XkFloat64);
#define xkCosA(x) _Generic((x), \
	XkFloat32: xkFCosA, \
  XkFloat64: xkDCosA)(x)

XKMATH_API XkFloat32 xkFCosH(const XkFloat32);
XKMATH_API XkFloat64 xkDCosH(const XkFloat64);
#define xkCosH(x) _Generic((x), \
	XkFloat32: xkFCosH, \
  XkFloat64: xkDCosH)(x)

XKMATH_API XkFloat32 xkFCosAH(const XkFloat32);
XKMATH_API XkFloat64 xkDCosAH(const XkFloat64);
#define xkCosAH(x) _Generic((x), \
	XkFloat32: xkFCosAH, \
  XkFloat64: xkDCosAH)(x)

XKMATH_API XkFloat32 xkFSin(const XkFloat32);
XKMATH_API XkFloat64 xkDSin(const XkFloat64);
#define xkSin(x) _Generic((x), \
	XkFloat32: xkFSin, \
  XkFloat64: xkDSin)(x)

XKMATH_API XkFloat32 xkFSinA(const XkFloat32);
XKMATH_API XkFloat64 xkDSinA(const XkFloat64);
#define xkSinA(x) _Generic((x), \
	XkFloat32: xkFSinA, \
  XkFloat64: xkDSinA)(x)

XKMATH_API XkFloat32 xkFSinH(const XkFloat32);
XKMATH_API XkFloat64 xkDSinH(const XkFloat64);
#define xkSinH(x) _Generic((x), \
	XkFloat32: xkFSinH, \
  XkFloat64: xkDSinH)(x)

XKMATH_API XkFloat32 xkFSinAH(const XkFloat32);
XKMATH_API XkFloat64 xkDSinAH(const XkFloat64);
#define xkSinAH(x) _Generic((x), \
	XkFloat32: xkFSinAH, \
  XkFloat64: xkDSinAH)(x)

XKMATH_API XkFloat32 xkFTan(const XkFloat32);
XKMATH_API XkFloat64 xkDTan(const XkFloat64);
#define xkTan(x) _Generic((x), \
	XkFloat32: xkFTan, \
  XkFloat64: xkDTan)(x)

XKMATH_API XkFloat32 xkFTanA(const XkFloat32);
XKMATH_API XkFloat64 xkDTanA(const XkFloat64);
#define xkTanA(x) _Generic((x), \
	XkFloat32: xkFTanA, \
  XkFloat64: xkDTanA)(x)

XKMATH_API XkFloat32 xkFTanH(const XkFloat32);
XKMATH_API XkFloat64 xkDTanH(const XkFloat64);
#define xkTanH(x) _Generic((x), \
	XkFloat32: xkFTanH, \
  XkFloat64: xkDTanH)(x)

XKMATH_API XkFloat32 xkFTanAH(const XkFloat32);
XKMATH_API XkFloat64 xkDTanAH(const XkFloat64);
#define xkTanAH(x) _Generic((x), \
	XkFloat32: xkFTanAH, \
  XkFloat64: xkDTanAH)(x)

XKMATH_API XkFloat32 xkFLog(const XkFloat32);
XKMATH_API XkFloat64 xkDLog(const XkFloat64);
XKMATH_API XkInt32 xkILog(const XkInt32);
XKMATH_API XkUInt32 xkULog(const XkUInt32);
XKMATH_API XkInt64 xkLILog(const XkInt64);
...
XKMATH_API XkInt32 xkIExp(const XkInt32);
XKMATH_API XkUInt32 xkUExp(const XkUInt32);
XKMATH_API XkInt64 xkLIExp(const XkInt64);
...
XKMATH_API XkInt32 xkIPow(const XkInt32, const XkInt32);
XKMATH_API XkUInt32 xkUPow(const XkUInt32, const XkUInt32);
XKMATH_API XkInt64 xkLIPow(const XkInt64, const XkInt64);
...
XKMATH_API XkFloat32 xkFFloor(const XkFloat32);
XKMATH_API XkFloat64 xkDFloor(const XkFloat64);
#define xkFloor(x) _Generic((x), \
	XkFloat32: xkFFloor, \
  XkFloat64: xkDFloor)(x)

XKMATH_API XkFloat32 xkFModF(const XkFloat32, XkFloat32*);
XKMATH_API XkFloat64 xkDModF(const XkFloat64, XkFloat64*);
#define xkModF(x) _Generic((x), \
	XkFloat32: xkFModF, \
  XkFloat64: xkDModF)(x)

XKMATH_API XkFloat32 xkFFMod(const XkFloat32, const XkFloat32);
XKMATH_API XkFloat64 xkDFMod(const XkFloat64, const XkFloat64);
...
XKMATH_API XkFloat32 xkFAbs(const XkFloat32);
XKMATH_API XkFloat64 xkDAbs(const XkFloat64);
