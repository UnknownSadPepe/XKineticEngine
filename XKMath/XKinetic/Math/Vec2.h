...
XK_INLINE XKMATH_API XkBool8 xkVec2Compare(const XkVec2 a, const XkVec2 b) {
#if defined(__XKMATH_AVX__) || defined(__XKMATH_AVX2__)
	/// TODO: Implementation.
#else
...
XK_INLINE XKMATH_API XkBool8 xkDVec2Compare(const XkDVec2 a, const XkDVec2 b) {
#if defined(__XKMATH_AVX__) || defined(__XKMATH_AVX2__)
	/// TODO: Implementation.
#else
...
XK_INLINE XKMATH_API XkFloat32 xkVec2Length(const XkVec2 a) {
	return xkFSqrt(a.x * a.x + a.y * a.y);
}

XK_INLINE XKMATH_API XkFloat64 xkDVec2Length(const XkDVec2 a) {
	return xkDSqrt(a.x * a.x + a.y * a.y);
}
